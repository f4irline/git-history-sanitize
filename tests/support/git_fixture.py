...
class GitFixture:
    ...
    def __init__(self, case: unittest.TestCase) -> None:
        ...
        # Local clone's upload-pack child drops command-scope configuration.
        # Trust only the container input mount; host runtimes need no exception.
        self.global_config.write_text(
            "[safe]\n\tdirectory = /input.git\n"
            if os.environ.get("GHS_TEST_RUNTIME") == "container" else ""
        )
